...
Every task is built with HTML and CSS only. None of them use JavaScript.
...
| 5 | Custom UI: Nebula Smart Home | [5-Custom-UI](5-Custom-UI/) | Glassmorphism, checkbox/radio hack, `:has()`, conic gradients, 3D flip card, theme switch |

Open `index.html` in this folder to reach all five tasks.
